...
<?php if ($comments) : ?>
	<h3 id="comments"><?php the_title(); ?>：目前有<?php comments_number('', '1 条留言', '% 条留言' );?></h3>
	<ol class="commentlist">
	<?php wp_list_comments('type=comment&callback=lomo_comment&end-callback=lomo_end_comment&max_depth=23'); ?>
	</ol>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	<?php if ('open' == $post->comment_status) : ?>
		...
		<h3 id="comments">我要评论：《<?php echo mb_strimwidth(get_the_title(), 0, 60, '...'); ?>》</h3>
	 <?php else : // comments are closed ?>
		<!-- If comments are closed. -->
		<p class="nocomments">好吧，这鸟人不让唠叨了。</p>
	<?php endif; ?>
	<?php endif; ?>
	<?php if ('open' == $post->comment_status) : ?>
	<div id="respond_box">
